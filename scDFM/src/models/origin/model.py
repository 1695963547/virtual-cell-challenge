...
class model(nn.Module):
    ...
    def forward(self,gene_id, cell_1, t, cell_2,  perturbation_id=None, gene_id_all=None, perturbation_emb=None, mode="predict_y", use_checkpoint=False, cell_line_id=None):
        if t.dim() == 0:
        ...
        for i,block in enumerate(self.blocks):
            ...
            if use_checkpoint:
                x = checkpoint(_run_block, block, x, value_emb_2, t_emb, use_reentrant=False)
            else:
