...
class PerturbationModel(ABC, LightningModule):
    ...
    def configure_optimizers(self):
        ...
        Supports 'adam' (default) and 'adamw' via model.kwargs.optimizer.
        """
        optimizer_name = self.hparams.get("kwargs", {}).get("optimizer", "adam")
        weight_decay = float(self.hparams.get("kwargs", {}).get("weight_decay", 0.01))
